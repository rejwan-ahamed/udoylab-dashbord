    ...
    <header>
        <div class="header-main">
            ...
            <div class="header-right">
                <ul>
                    <li>
                        <router-link to="/" class="header-links-main">Home</router-link>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row g-5">
            <div class="col-md-5 col-lg-4 order-md-last">
                ...
                <div class="form-group form-img-main">
                    ...
                    <input type="url" class="form-control mb-5" id="exampleFormControlFile1"
                        enctype="multipart/form-data" v-model="img1" />
                </div>

                <div class="form-group form-img-main">
                    <label for="exampleFormControlFile1" class="py-3">Choose Thambnail url</label>
                    <input type="url" class="form-control mb-4" id="exampleFormControlFile1" v-model="img2">
                </div>


                <div class="form-group main-form-title-area py-3">
                    <label for="exampleFormControlTextarea1" class="py-2">Post Title</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" v-model="title"></textarea>
                </div>
                <div class="form-group main-form-title-area py-3">
                ...
                <div class="col-md-5 form-tags">
                    ...
                    <select class="form-select" id="country" required="" v-model="tag">
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <div class="editor-button-main">
                    <button class="post-sub-button-main" v-on:click="show()">Submit</button>
                    <!-- <button class="cancel-sub-button-main"  v-on:click="cancel()">Cancel</button> -->
...
export default {
    ...
    methods: {
        ...
        // async show() {
        //     // const datamain = this.inputValue
        //     // alert(datamain)
        ...
        async show() {
            ...
            if (this.img1 == "" || this.img2 == "" || this.title == "" || this.tag == "" || this.content == "") {
                ...
                let results = await axios.post("https://udoylabapi.redhalozenn.xyz/project", {
                    "img1": this.img1,
                    "img2": this.img2,
                    "title": this.title,
