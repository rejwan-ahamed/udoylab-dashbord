        ...
        <div class="header-main">
            ...
            <div class="header-right">
                <ul>
                    ...
                    <li>
                        <router-link to="/add" class="header-links-main">Add post</router-link>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row g-5">
            <div class="col-md-5 col-lg-4 order-md-last">
                ...
                <div class="form-group form-img-main">
                    ...
                    <input type="url" class="form-control mb-4" id="exampleFormControlFile1" v-model="this.dataup.img2">
                </div>
                ...
                <div class="form-group main-form-title-area py-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                        v-model="this.dataup.title"></textarea>
                </div>
                <div class="form-group main-form-title-area py-3">
